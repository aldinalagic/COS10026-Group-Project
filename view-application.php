...
<body id="manage-body">
    ...
    echo "<form id='manage-form'>",
        ...
        '<div id="personal-info-manage" class="manage-section">',
            ...
            createInput('date', 'dob', 0, InputSize::Normal, $application['dob'], '', false, true, 'Date of Birth'),
            ...
            createInput('select', 'gender', 0, InputSize::Normal, $application['gender'], '', false, true, 'Gender'),
        '</div>',
