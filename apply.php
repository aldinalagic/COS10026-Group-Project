        ...
        <form method="post" action="http://mercury.swin.edu.au/it000000/formtest.php">
            <section id="personal-information">
                ...
                <div class="apply-grid">
                    <div class="input-field">
                        ...
                        <input type="text" name="first-name" id="first-name" class="input" maxlength="20" size="10" required placeholder="Enter your first name">
                    </div>
                    
                    <div class="input-field">
                        <label for="last-name">Last name</label>
                        <input type="text" name="last-name" id="last-name" class="input" maxlength="20" size="10" required placeholder="Enter your last name">
                    </div>
                    
                    <div class="input-field">
                        <label for="date-of-birth">Date of birth</label>
                        <input type="text" name="date-of-birth" id="date-of-birth" class="input" pattern="\d{2}/\d{2}/\d{4}" required placeholder="dd/mm/yyyy">
                    </div>
                    
                    <div class="input-field">
                        <label for="street-address">Street address</label>
                        <input type="text" name="street-address" id="street-address" class="input" maxlength="40" required placeholder="Enter your street address">
                    </div>
                    
                    <div class="input-field">
                        <label for="suburb">Suburb</label>
                        <input type="text" name="suburb" id="suburb" class="input" maxlength="40" required placeholder="Enter your suburb">
                    </div>
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" name="postcode" id="postcode" class="input" pattern="[0-9]{4}" required placeholder="Enter your postcode">
                    </div>
            ...
            <section id="contact-details">
                ...
                <div id="apply-grid-2">
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" name="phone-number" id="phone-number" class="input" pattern="[0-9]{3}-[0-9]{3}-[0-9]{3}" required placeholder="000-000-000">
                    </div>
                </div>

                <div class="button-group">
                    <a href="#personal-information">
                        <button class="button-shaded" type="button">Back</button>
                    </a>
    
                    <a href="#role-information">
                        <button class="button-primary" type="button">Next</button>
                    </a>
                </div>
            </section>
            ...
            <section id="role-information">
                ...
                <div class="button-group">
                    ...
                    <button class="button-primary" type="submit"><img src="images/icons/rocket.svg" alt="Submit Icon">Submit</button>
                </div>
            </section>
        </form>
    </div>
